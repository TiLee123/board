        ...
        <div data-role="content">
            <form method="post" action="" data-ajax="false">
                ...
                <div data-role="fieldcontain">
                    ...
                    <input type="text" value="{{ $emp->firstName }}" id="firstName" name="firstName" value="" />
                </div>
                <div data-role="fieldcontain">
                    <label for="lastName">Last name:</label>
                    <input type="text" value="{{ $emp->lastName }}" id="lastName" name="lastName" value="" />
                </div>
                <div>....</div>
                <div data-role="fieldcontain">
                    <label for="email">E-mail:</label>
                    <input type="text" value="{{ $emp->email }}" id="email" name="email" value="" />
                </div>
